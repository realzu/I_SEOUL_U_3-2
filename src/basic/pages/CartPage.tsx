...
import { ActionResult, AddNotification, CartActions, CartItem, CouponActions, Product, ProductActions } from "../../types";
...
function CartPage({ products, cart, formatPrice, getRemainingStock, debouncedSearchTerm, notify, addToCart, removeFromCart, updateQuantity, selectedCoupon, addNotification, clearCart, coupons, applyCoupon, clearSelectedCoupon }: CartPageProps) {
